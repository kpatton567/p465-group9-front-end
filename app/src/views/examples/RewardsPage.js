      ...
      <div className="section profile-content">
        <Container>
          ...
          <div className= {classes.coupon}>
                ...
                <img src="https://silicondales.com/wp-content/uploads/2018/03/cloud-20-per-cent-off.jpg" alt="Avatar" style={{width:"100%"}}></img>
                <div className={classes.container} style={{backgroundColor:'white'}}>
                <b>20% OFF YOUR PURCHASE</b>
                </div>
                <div className={classes.container}>
                <p>Use Promo Code: <span className={classes.promo}>BOH232</span></p>
            ...
            <div className= {classes.coupon}>
                ...
                <img src="https://image.freepik.com/free-vector/smiling-girls-kids-holding-hands-friendship-concept-children-cartoon-characters_71593-357.jpg" alt="Avatar" style={{width:"100%"}}></img>
                <div className={classes.container} style={{backgroundColor:'white'}}>
            ...
            <div className= {classes.coupon}>
                ...
                <img src="https://static.vonbeau.net/images/uploads/offer/free-movie-ticket-atom-tickets.jpg" alt="Avatar" style={{width:"100%"}}></img>
                <div className={classes.container} style={{backgroundColor:'white'}}>
